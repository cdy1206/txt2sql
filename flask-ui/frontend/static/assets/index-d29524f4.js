...
function qr(r) {
    ...
    return {
        c() {
            ...
            已连接（Chinook）</p></div> <div class="p-4 border-t border-gray-200 dark:border-gray-700"><a class="flex justify-between items-center gap-x-3 py-2 px-3 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300" href="#replace">退出登录
...
function Mr(r) {
    ...
    return {
        c() {
            e = E("div"), e.innerHTML = '<h1 class="text-3xl font-bold text-gray-800 sm:text-4xl dark:text-white"> Welcome <span class="nav-title">Intelligent Data Analysis System </span></h1> <p class="mt-3 text-gray-600 dark:text-gray-400">Your most reliable and intimate SQL query artificial intelligence assistant </p>', v(e, "class", "max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto text-center")
        }, m(n, t) {
            U(n, e, t)
        }, p: se, i: se, o: se, d(n) {
            n && G(e)
...
function zr(r) {
    ...
    return {
        c() {
            e = E("div"), n = E("input"), t = Z(), o = E("div"), i = E("div"), s = E("div"), s.innerHTML = "", l = Z(), c = E("div"), a = E("button"), a.innerHTML = '<svg class="h-3.5 w-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="M15.964.686a.5.5 0 0 0-.65-.65L.767 5.855H.766l-.452.18a.5.5 0 0 0-.082.887l.41.26.001.002 4.995 3.178 3.178 4.995.002.002.26.41a.5.5 0 0 0 .886-.083l6-15Zm-1.833 1.89L6.637 10.07l-.215-.338a.5.5 0 0 0-.154-.154l-.338-.215 7.494-7.494 1.178-.471-.47 1.178Z"></path></svg>', v(n, "type", "text"), v(n, "class", "p-4 pb-12 block w-full bg-gray-100 border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-800 dark:border-gray-700 dark:text-gray-400"), v(n, "placeholder", "您可以向我提出任何关于数据的问题，我会将其转化为最优的SQL语句。"), v(s, "class", "flex items-center"), v(a, "type", "button"), v(a, "class", "inline-flex flex-shrink-0 justify-center items-center h-8 w-8 rounded-md text-white bg-blue-600 hover:bg-blue-500 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"), v(c, "class", "flex items-center gap-x-1"), v(i, "class", "flex justify-between items-center"), v(o, "class", "absolute bottom-px inset-x-px p-2 rounded-b-md bg-gray-100 dark:bg-slate-800"), v(e, "class", "relative")
        }, m(k, x) {
...
function Jr(r) {
    ...
    return {
        c() {
            e = E("li"), n = E("img"), o = Z(), i = E("div"), c && c.c(), or(n.src, t = "/dquestion-llm-icon.png") || v(n, "src", t), v(n, "class", "flex-shrink-0 w-[2.375rem] h-[2.375rem] "), v(n, "alt", "agent logo"), v(i, "class", "space-y-3 overflow-x-auto overflow-y-hidden"), v(e, "class", "max-w-4xl py-2 px-4 sm:px-6 lg:px-8 mx-auto flex gap-x-2 sm:gap-x-4")
        }, m(a, d) {
...
function eo(r) {
    ...
    return s = new pt({props: {$$slots: {default: [Xr]}, $$scope: {ctx: r}}}), {
        c() {
            e = E("li"), n = E("img"), o = Z(), i = E("div"), J(s.$$.fragment), or(n.src, t = "/dquestion.svg") || v(n, "src", t), v(n, "class", "flex-shrink-0 w-[2.375rem] h-[2.375rem] animate-bounce "), v(n, "alt", "agent logo"), v(i, "class", "space-y-3"), v(e, "class", "max-w-4xl py-2 px-4 sm:px-6 lg:px-8 mx-auto flex gap-x-2 sm:gap-x-4")
        }, m(c, a) {
...
function ko(r) {
    let e, n;
    return e = new Mt({props: {message: "请在此输入您的SQL语句", $$slots: {default: [Po]}, $$scope: {ctx: r}}}), {
        c() {
            J(e.$$.fragment)
        }, m(t, o) {
            F(e, t, o), n = !0
...
function Qo(r) {
    let e, n;
    return e = new Mt({props: {message: "结果不正确。"}}), {
        c() {
            J(e.$$.fragment)
        }, m(t, o) {
            F(e, t, o), n = !0
...
function Jo(r) {
    let e, n, t, o;
    e = new ur({props: {message: "新的问题", onSubmit: r[5]}});
    let i = _e(r[2]), s = [];
...
function ii(r, e, n) {
    let {onDismiss: t} = e, {onTrain: o} = e, {selectedTrainingDataType: i = "SQL"} = e, s = [{
        name: "DDL",
        description: "这些是定义您数据库结构的CREATE TABLE语句。",
        example: "CREATE TABLE table_name (column_1 datatype, column_2 datatype, column_3 datatype);"
    }, {
        name: "Documentation",
        description: "这可以是任何基于文本的文档。保持内容块小而精，专注于单一主题。",
        example: "我们对ABC的定义是XYZ。"
    }, {
        name: "SQL",
        description: "这可以是任何有效的SQL语句，越多越好。",
...
function fi(r) {
    ...
    return {
        c() {
            Te && Te.c(), e = Z(), n = E("div"), t = E("div"), o = E("div"), i = E("div"), s = E("div"), l = E("div"), c = E("div"), c.innerHTML = '<h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">训练数据</h2> <p class="text-sm text-gray-600 dark:text-gray-400">添加或移除训练数据。良好的训练数据是准确性的关键。</p>', a = Z(), d = E("div"), g = E("div"), k = E("button"), k.textContent = "查看全部", x = Z(), D = E("button"), D.innerHTML = `<svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2.63452 7.50001L13.6345 7.5M8.13452 13V2" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path></svg>
